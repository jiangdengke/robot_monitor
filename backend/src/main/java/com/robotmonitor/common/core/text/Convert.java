 ...
 */
package com.robotmonitor.common.core.text;

import com.robotmonitor.common.core.text.CharsetKit;
...
public class Convert {
    ...
    public static Boolean toBool(Object value, Boolean defaultValue) {
        ...
        switch (valueStr = valueStr.trim().toLowerCase(Locale.ENGLISH)) {
            case "true": 
            case "yes": 
            case "ok": 
            case "1": {
    ...
    public static String str(Object obj, Charset charset) {
        ...
        if (obj instanceof Byte[]) {
            byte[] bytes = ArrayUtils.toPrimitive((Byte[])((Byte[])obj));
    ...
    public static String digitUppercase(double n) {
        ...
        for (int i = 0; i < fraction.length; ++i) {
            s = (String)s + (digit[(int)(Math.floor(n * 10.0 * Math.pow(10.0, i)) % 10.0)] + fraction[i]).replaceAll("(\u96f6.)+", "");
        }
