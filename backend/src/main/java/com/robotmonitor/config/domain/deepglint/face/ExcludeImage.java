...
public class ExcludeImage {
    ...
    public ExcludeImage(String url) {
        this.url = url;
    }
    ...
    public String toString() {
        return "ExcludeImage{url='" + this.url + "', binData='" + (this.binData != null ? "[OMITTED]" : null) + "', feature='" + this.feature + "', rectangles=" + this.rectangles + ", boundingBoxes=" + this.boundingBoxes + "}";
    }
}
