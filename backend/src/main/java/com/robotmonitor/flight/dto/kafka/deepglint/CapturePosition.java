...
public class CapturePosition {
    ...
    public String toString() {
        ...
        sb.append(CapturePosition.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("x");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CapturePosition)) {
            return false;
        }
        CapturePosition rhs = (CapturePosition)other;
