...
VALUES
(1,'首页',0,1,'','index',NULL,'1','0','C','0','0','','dashboard','system',NOW(),''),
(2,'统计分析',0,2,'statAnalysis',NULL,NULL,'1','0','M','0','0','','chart','system',NOW(),''),
(3,'餐食管理',0,3,'foodManagment',NULL,NULL,'1','0','M','0','0','','food','system',NOW(),''),
(4,'日志管理',0,4,'logs',NULL,NULL,'1','0','M','0','0','','log','system',NOW(),''),
(5,'基础配置',0,5,'configManagment',NULL,NULL,'1','0','M','0','0','','edit','system',NOW(),''),
(6,'系统管理',0,6,'system',NULL,NULL,'1','0','M','0','0','','system','system',NOW(),''),
(7,'系统监控',0,7,'monitor',NULL,NULL,'1','0','M','0','0','','monitor','system',NOW(),''),
(8,'V17',0,8,'digitalTwin','digitalTwin/index',NULL,'1','0','C','0','0','flight:digitalTwin:view','digital-twin-view','system',NOW(),''),
(9,'V15',0,9,'digitalTwin/v15','digitalTwin/v15',NULL,'1','0','C','0','0','flight:digitalTwin:view','map','system',NOW(),''),

(200,'在舱记录',2,1,'inLoungeList','statAnalysis/inLoungeList/index',NULL,'1','0','C','0','0','system:passenger:list,system:passenger:query,system:passenger:add,system:passenger:edit,system:passenger:remove,system:passenger:export','people','system',NOW(),''),
(201,'准出记录',2,2,'/viewManagment/outGoing','viewManagment/outGoing/index',NULL,'1','0','C','0','0','flight:outGoing:list','walk','system',NOW(),''),
(202,'问询统计',2,3,'questionStat','statAnalysis/questionStat/index',NULL,'1','0','C','0','0','flight:questionStat:list','chart','system',NOW(),''),
(203,'引导统计',2,4,'/knowledgeManagment/ai/log','knowledgeManagment/ai/log/index',NULL,'1','0','C','0','0','ai:log:list,ai:log:query,ai:log:export','shopping','system',NOW(),''),
(204,'准入记录',2,5,'goingStat','statAnalysis/goingStat/index',NULL,'1','0','C','0','0','flight:goingStat:list','chart','system',NOW(),''),

(300,'菜品管理',3,1,'food','foodManagment/food/index',NULL,'1','0','C','0','0','food:config:list,food:config:query,food:config:add,food:config:edit,food:config:remove','food','system',NOW(),''),
(301,'菜单计划',3,2,'foodPlan','foodManagment/foodPlan/index',NULL,'1','0','C','0','0','food:plan:list,food:plan:query,food:plan:add,food:plan:edit,food:plan:remove','calendar','system',NOW(),''),
(302,'每日菜单',3,3,'menuPlan','foodManagment/menuPlan/index',NULL,'1','0','C','0','0','food:daily:list,food:daily:query,food:daily:add,food:daily:edit,food:daily:remove','menuPlan','system',NOW(),''),

(400,'操作日志',4,1,'/monitor/operlog','monitor/operlog/index',NULL,'1','0','C','0','0','monitor:operlog:list,monitor:operlog:query,monitor:operlog:remove,monitor:operlog:export','log','system',NOW(),''),
(401,'登录日志',4,2,'/monitor/logininfor','monitor/logininfor/index',NULL,'1','0','C','0','0','monitor:logininfor:list,monitor:logininfor:query,monitor:logininfor:remove,monitor:logininfor:export','logininfor','system',NOW(),''),

(500,'贵宾室',5,1,'vipRoom','configManagment/vipRoom/index',NULL,'1','0','C','0','0','config:vipRoom:list,config:vipRoom:query,system:dept:list,system:dept:query','list','system',NOW(),''),
(501,'功能区',5,2,'areaManagment','configManagment/areaManagment/index',NULL,'1','0','C','0','0','config:area:list,config:area:query','tree-table','system',NOW(),''),
(502,'区域',5,3,'vipRoomRegion','configManagment/vipRoomRegion/index',NULL,'1','0','C','0','0','config:region:list,config:region:query,config:region:add,config:region:edit,config:region:remove,config:region:export','table','system',NOW(),''),
(503,'餐桌管理',5,4,'/foodManagment/foodTable','foodManagment/foodTable/index',NULL,'1','0','C','0','0','config:table:list,config:table:query,config:table:add,config:table:edit,config:table:remove,food:table:list','table','system',NOW(),''),
(504,'摄像头',5,5,'monitorDevice','configManagment/monitorDevice/index',NULL,'1','0','C','0','0','config:device:list,config:device:query','camera','system',NOW(),''),
(505,'机器人',5,6,'robot','configManagment/robot/index',NULL,'1','0','C','0','0','config:robot:list,config:robot:query,config:robot:add,config:robot:edit,config:robot:remove','robot','system',NOW(),''),
(506,'机器人音频',5,7,'robotAudio','configManagment/robotAudio/index',NULL,'1','0','C','0','0','config:audio:list,config:audio:query,config:audio:add,config:audio:edit,config:audio:remove','sound','system',NOW(),''),
(507,'音频',5,8,'audio','configManagment/audio/index',NULL,'1','0','C','0','0','config:audio:list,config:audio:query,config:audio:add,config:audio:edit,config:audio:remove','chart','system',NOW(),''),
(508,'图片',5,9,'photo','configManagment/photo/index',NULL,'1','0','C','0','0','config:photo:list,config:photo:query,config:photo:add,config:photo:edit,config:photo:remove','image','system',NOW(),''),
(509,'任务列表',5,10,'/taskManagment/taskList','taskManagment/taskList/index',NULL,'1','0','C','0','0','config:task:list,config:task:query,config:task:add,config:task:edit,config:task:remove','list','system',NOW(),''),
(510,'知识库列表',5,11,'/knowledgeManagment/ai/knowledge','knowledgeManagment/ai/knowledge/index',NULL,'1','0','C','0','0','ai:knowledge:list,ai:knowledge:query,ai:knowledge:add,ai:knowledge:edit,ai:knowledge:remove,ai:knowledge:embedding,ai:queue:notice','box','system',NOW(),''),

(600,'用户管理',6,1,'user','system/user/index',NULL,'1','0','C','0','0','system:user:list,system:user:query,system:user:add,system:user:edit,system:user:remove,system:user:resetPwd,system:user:import,system:user:export','user','system',NOW(),''),
(601,'角色管理',6,2,'role','system/role/index',NULL,'1','0','C','0','0','system:role:list,system:role:query,system:role:add,system:role:edit,system:role:remove,system:role:export','peoples','system',NOW(),''),
(602,'菜单管理',6,3,'menu','system/menu/index',NULL,'1','0','C','0','0','system:menu:list,system:menu:query,system:menu:add,system:menu:edit,system:menu:remove','tree','system',NOW(),''),
(603,'字典管理',6,4,'dict','system/dict/index',NULL,'1','0','C','0','0','system:dict:list,system:dict:query,system:dict:add,system:dict:edit,system:dict:remove,system:dict:export','dict','system',NOW(),''),
...
(2,300),(2,301),(2,302),
(2,400),(2,401),
(2,500),(2,501),(2,502),(2,503),(2,504),(2,505),(2,506),(2,507),(2,508),(2,509),(2,510),
(2,600),(2,601),(2,602),(2,603),(2,604),
(2,700),(2,701),(2,702),(2,703);
