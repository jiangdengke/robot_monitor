...
import com.robotmonitor.config.domain.deepglint.similar.PersonSimilarData;
import java.util.LinkedHashMap;
import java.util.Map;

@JsonInclude(value=JsonInclude.Include.NON_NULL)
@JsonPropertyOrder(value={"Code", "Msg", "Data"})
public class PersonSimilarResponse {
    @JsonProperty(value="Code")
    private Integer code;
    @JsonProperty(value="Msg")
    private String msg;
    @JsonProperty(value="Data")
    private PersonSimilarData data;
    @JsonIgnore
    ...
    @JsonProperty(value="Data")
    public PersonSimilarData getData() {
        return this.data;
    }

    @JsonProperty(value="Data")
    public void setData(PersonSimilarData data) {
        this.data = data;
    }
    ...
    public String toString() {
        ...
        sb.append(PersonSimilarResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PersonSimilarResponse)) {
            return false;
        }
        PersonSimilarResponse rhs = (PersonSimilarResponse)other;
