...
public class OriginImg {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OriginImg)) {
            return false;
        }
        OriginImg other = (OriginImg)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OriginImg;
    }
    ...
    public String toString() {
        return "OriginImg(id=" + this.getId() + ", width=" + this.getWidth() + ", height=" + this.getHeight() + ", uri=" + this.getUri() + ", sn=" + this.getSn() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
}
