...
public class FoodOrderDetailParamter {
    private Long foodId;
    private int num;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FoodOrderDetailParamter)) {
            return false;
        }
        FoodOrderDetailParamter other = (FoodOrderDetailParamter)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FoodOrderDetailParamter;
    }
    ...
    public String toString() {
        return "FoodOrderDetailParamter(foodId=" + this.getFoodId() + ", num=" + this.getNum() + ")";
    }
}
