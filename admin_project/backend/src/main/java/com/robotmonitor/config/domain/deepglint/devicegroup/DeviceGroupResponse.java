...
public class DeviceGroupResponse {
    ...
    private DeviceGroupData data;

    public DeviceGroupResponse() {
    }

    public DeviceGroupResponse(Integer code, String msg, DeviceGroupData data) {
        this.code = code;
        this.msg = msg;
        this.data = data;
    }
    ...
    public DeviceGroupData getData() {
        return this.data;
    }

    public void setData(DeviceGroupData data) {
        this.data = data;
    }
