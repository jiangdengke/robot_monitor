...
import com.robotmonitor.config.domain.deepglint.device.DeviceInfoData;
...
public class GetDeviceInfoResponse {
    ...
    public GetDeviceInfoResponse(Integer code, String msg, DeviceInfoData data) {
        this.code = code;
        this.msg = msg;
        this.data = data;
    }
    ...
    public void setData(DeviceInfoData data) {
        this.data = data;
    }
