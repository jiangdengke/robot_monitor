...
public class RobotChatImage {
    private String imageName;
    private String imageData;

    public RobotChatImage() {
    }

    public RobotChatImage(String imageName, String imageData) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RobotChatImage)) {
            return false;
        }
        RobotChatImage other = (RobotChatImage)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RobotChatImage;
    }
    ...
    public String toString() {
        return "RobotChatImage(imageName=" + this.getImageName() + ", imageData=" + this.getImageData() + ")";
    }
}
