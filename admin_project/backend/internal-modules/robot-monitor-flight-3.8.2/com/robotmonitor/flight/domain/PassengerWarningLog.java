...
public class PassengerWarningLog
extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PassengerWarningLog)) {
            return false;
        }
        PassengerWarningLog other = (PassengerWarningLog)((Object)o);
        ...
        Long this$robotTaskId = this.getRobotTaskId();
        Long other$robotTaskId = other.getRobotTaskId();
        if (this$robotTaskId == null ? other$robotTaskId != null : !((Object)this$robotTaskId).equals(other$robotTaskId)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PassengerWarningLog;
    }
    ...
    public int hashCode() {
        ...
        Long $robotTaskId = this.getRobotTaskId();
        result = result * 59 + ($robotTaskId == null ? 43 : ((Object)$robotTaskId).hashCode());
    ...
    public String toString() {
        return "PassengerWarningLog(id=" + this.getId() + ", passengerId=" + this.getPassengerId() + ", flightId=" + this.getFlightId() + ", flightWarningId=" + this.getFlightWarningId() + ", warningType=" + this.getWarningType() + ", noticeType=" + this.getNoticeType() + ", regionId=" + this.getRegionId() + ", warningInfo=" + this.getWarningInfo() + ", isSuccess=" + this.getIsSuccess() + ", robotTaskId=" + this.getRobotTaskId() + ")";
    }
}
