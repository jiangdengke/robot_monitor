...
public class SnapBox {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnapBox)) {
            return false;
        }
        SnapBox other = (SnapBox)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SnapBox;
    }
    ...
    public String toString() {
        return "SnapBox(x=" + this.getX() + ", y=" + this.getY() + ", width=" + this.getWidth() + ", height=" + this.getHeight() + ", confidence=" + this.getConfidence() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
}
