...
public class Cutboard {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Cutboard)) {
            return false;
        }
        Cutboard other = (Cutboard)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Cutboard;
    }
    ...
    public String toString() {
        return "Cutboard(x=" + this.getX() + ", y=" + this.getY() + ", width=" + this.getWidth() + ", height=" + this.getHeight() + ", confidence=" + this.getConfidence() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
    }
}
