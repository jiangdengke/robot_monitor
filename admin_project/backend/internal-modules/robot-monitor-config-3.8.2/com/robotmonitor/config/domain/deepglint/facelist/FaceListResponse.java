...
import com.robotmonitor.config.domain.deepglint.facelist.FaceListData;
...
public class FaceListResponse {
    ...
    public String toString() {
        ...
        sb.append(FaceListResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof FaceListResponse)) {
            return false;
        }
        FaceListResponse rhs = (FaceListResponse)other;
